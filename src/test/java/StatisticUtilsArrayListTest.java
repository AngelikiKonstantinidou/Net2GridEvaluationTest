...
/**
 * StatisticUtilsArrayListTest is test class created to {@link StatisticUtilsArrayList}. The class contains factory
 * methods which generate the arguments of each test and the test methods for the following functionalities:
 * <p>
 * a. Minimum Value
 * b. Maximum Value
 * c. Median Value
...
public class StatisticUtilsArrayListTest {
     ...
     * of {@link StatisticUtilsArrayList}. Specifically, each argument is a combination of the input array of doubles
    ...
    private static Stream<Arguments> getMinArguments() {
        return Stream.of(
                Arguments.of(new ArrayList<>(Arrays.asList(1.0, 2.0, 1.1, 4.8, 9.2)), 1.0),
                Arguments.of(new ArrayList<>(Arrays.asList(-1.0, -2.0, -1.1, -4.8, -9.2)), -9.2),
                Arguments.of(new ArrayList<>(Arrays.asList(-1.0, 100.0, 1.1, -4.5, 0.0)), -4.5),
    ...
    private static Stream<Arguments> getMaxArguments() {
        return Stream.of(
                Arguments.of(new ArrayList<>(Arrays.asList(1.0, 2.0, 1.1, 4.8, 9.2)), 9.2),
                Arguments.of(new ArrayList<>(Arrays.asList(-1.0, -2.0, -1.1, -4.8, -9.2)), -1.0),
                Arguments.of(new ArrayList<>(Arrays.asList(-1.0, 100.0, 1.1, -4.5, 0.0)), 100.0),
                Arguments.of(new ArrayList<Double>(), Double.NaN));
    }

    /**
     * Generates and returns a stream with possible arguments for testing the implementation of the median functionality
     * of {@link StatisticUtilsArrayList}. Specifically, each argument is the combination of the input array of doubles
    ...
    private static Stream<Arguments> getMedianArguments() {
        return Stream.of(
                Arguments.of(new ArrayList<>(Arrays.asList(1.0, 2.0, 1.1, 4.8, 9.2)), 2.0),
                Arguments.of(new ArrayList<>(Arrays.asList(-1.0, -2.0, -1.1, -4.8, -9.2)), -2.0),
                Arguments.of(new ArrayList<>(Arrays.asList(-1.0, 100.0, 1.1, -4.5, 0.0)), 0.0),
                Arguments.of(new ArrayList<>(Arrays.asList(4.1, 2.5, 6.45, 5.6668, 1.01, 1.02, 6.4)), 4.1),
                Arguments.of(new ArrayList<>(Arrays.asList(4.1, 2.5, 6.45, 5.6668, 1.01, 1.02)), 3.3),
                Arguments.of(new ArrayList<>(), Double.NaN));
    }
    ...
    private static Stream<Arguments> getMeanArguments() {
        return Stream.of(
                Arguments.of(new ArrayList<>(Arrays.asList(1.0, 2.0, 1.1, 4.8, 9.2)), 3.62),
                Arguments.of(new ArrayList<>(Arrays.asList(-1.0, -2.0, -1.1, -4.8, -9.2)), -3.62),
                Arguments.of(new ArrayList<>(Arrays.asList(-1.0, 100.0, 1.1, -4.5)), 23.9),
                Arguments.of(new ArrayList<>(), Double.NaN));
    }

    /**
     * Generates and returns a stream with arguments for testing the implementation of the standard deviation
     * functionality of {@link StatisticUtilsArrayList}. Specifically, each argument is the combination of the input array
    ...
    private static Stream<Arguments> getStandardDeviationArguments() {
        return Stream.of(
                Arguments.of(new ArrayList<>(Arrays.asList(1.0, 2.0, 1.1, 4.0, 5.5)), 1.758863269273652),
                Arguments.of(new ArrayList<>(Arrays.asList(-1.0, -2.0, -1.1, -4.8, -9.2)), 3.1102411482070003),
                Arguments.of(new ArrayList<>(Arrays.asList(-1.0, 100.0, 1.1, -4.5, 0.0)), 40.4835472754056),
                Arguments.of(new ArrayList<>(), Double.NaN));
    }
     ...
     *
     * @param list          The input array list of doubles
     * @param expectedValue The expected min value
     */
    @DisplayName("Executes all the minimum value test cases")
    @ParameterizedTest(name = "{index} => list =''{0}'', expectedValue=''{1}''")
    @MethodSource("getMinArguments")
    public void testMinimumValue(ArrayList<Double> list, double expectedValue) {
        StatisticUtilsArrayList stats = new StatisticUtilsArrayList(list);
    ...
    public void testMaximumValue(ArrayList<Double> list, double expectedValue) {
        StatisticUtilsArrayList stats = new StatisticUtilsArrayList(list);
    ...
    public void testMedianValue(ArrayList<Double> list, double expectedValue) {
        StatisticUtilsArrayList stats = new StatisticUtilsArrayList(list);
    ...
    public void testMeanValue(ArrayList<Double> list, double expectedValue) {
        StatisticUtilsArrayList stats = new StatisticUtilsArrayList(list);
    ...
    public void testStandardDeviationValue(ArrayList<Double> list, double expectedValue) {
        StatisticUtilsArrayList stats = new StatisticUtilsArrayList(list);
