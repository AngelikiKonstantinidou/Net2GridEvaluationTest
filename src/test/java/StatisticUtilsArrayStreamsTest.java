...
/**
 * StatisticUtilsArrayStreamsTest is test class created to test {@link StatisticUtilsArrayStreams}. The class contains
 * factory methods which generate arguments for each test and the test methods for the following functionalities:
 * <p>
 * a. Minimum Value
 * b. Maximum Value
 * c. Median Value
 ...
 */
public class StatisticUtilsArrayStreamsTest {

    /**
     * Generates and returns a stream with possible arguments for testing the implementation of the min functionality
     * of {@link StatisticUtilsArrayStreams}. Specifically, each argument is a combination of the input array of doubles
     ...
     * of {@link StatisticUtilsArrayStreams}. Specifically, each argument is the combination of the input array of doubles
     ...
     * functionality of {@link StatisticUtilsArrayStreams}. Specifically, each argument is the combination of the input array
    ...
    /**
     * Tests the min implementation by examining different cases of arguments that are coming as input from the factory
    ...
    /**
     * Tests the max implementation by examining different cases of arguments that are coming as input from the factory
    ...
    /**
     * Tests the median implementation by examining different cases of arguments that are coming as input from the factory
    ...
    /**
     * Tests the mean implementation by examining different cases of arguments that are coming as input from the factory
    ...
    /**
     * Tests the standard deviation implementation by examining different cases of arguments that are coming as input
     * from the factory method getStandardDeviationArguments.
     *
     * @param array         The input array of doubles
     * @param expectedValue The expected median value
     */
